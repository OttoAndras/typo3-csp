...
class YoutubeRendererTest extends UnitTestCase
{
    ...
    {
        parent::setUp();
        $this->subject = $this->getMock(YouTubeRenderer::class, ['getOnlineMediaHelper']);
    ...
    public function rendersIframe() {
        ...
        $this->assertEquals('frame-src www.youtube.com; child-src www.youtube.com;', $header['value']);
    }
